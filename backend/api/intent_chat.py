...
def _turn_to_response(result: OrchestratorTurnResult) -> IntentChatResponse:
    ...
    if result.basket_summary:
        ...
        basket = BasketSummarySchema(
            ...
            address_display=b.address_display,
            budget=b.budget,
            ...
            selected_payment_option_kind=b.selected_payment_option_kind,
            selected_payment_option_label=b.selected_payment_option_label,
