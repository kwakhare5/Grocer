...
### [PreFill — Deep Codebase Cleanup & Authentic iOS 18 Frosted Glass Material] 2026-08-15
- **Commit**: `pending`
- **Shipped**:
  - Upgraded notification card to authentic Apple iOS 18 **Frosted Glass Material** (`bg-[#232326]/85 backdrop-blur-2xl backdrop-saturate-[180%] border border-white/20 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.45)]`) in `IosNotificationBanner.tsx`.
