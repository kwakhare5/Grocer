  ...
  return (
    <CardSurface variant="default" showDotPattern={true} className="!p-8 sm:!p-10 space-y-8">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-gray-100 pb-6">
        <div>
          <span className="text-[11px] font-semibold text-sky-700 uppercase tracking-widest flex items-center gap-1.5">
            <Zap className="w-3.5 h-3.5 text-sky-600" /> Interactive Stockout Engine
          </span>
        ...
        <div className="flex items-center gap-2 bg-gray-50 p-2 rounded-full border border-gray-200/80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        {/* Right Column: 21st.dev Animated Rolling Hours Remaining */}
        <div className="lg:col-span-5 bg-sky-50/80 p-6 rounded-2xl border border-sky-200/80 space-y-4 text-center">
          <span className="text-xs font-bold text-sky-800 uppercase tracking-widest flex items-center justify-center gap-1.5">
            <Clock className="w-4 h-4 text-sky-600" /> Projected Depletion
          </span>

          <div className="space-y-1">
            <div className="text-5xl font-serif font-light text-gray-950 tracking-tighter flex items-center justify-center gap-1">
              <span>~</span>
            ...
            <p className="text-xs text-gray-500 font-medium">Until Fresh Milk is empty</p>
          </div>
