...
function FillShadow() {
  return (
    <div className="absolute inset-0 rounded-[20px] bg-white/75 backdrop-blur-2xl backdrop-saturate-[180%] border border-white/60 shadow-[0_4px_20px_rgba(0,0,0,0.12)]">
      <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[20px]">
        <div className="absolute bg-white/40 inset-0 rounded-[20px]" />
      </div>
    </div>
  );
}
...
function GlassEffect() {
  return (
    <div className="absolute inset-0 pointer-events-none rounded-[20px]">
      <div aria-hidden className="absolute inset-0 rounded-[inherit] shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.9)]" />
    </div>
  );
}
            ...
            <div className="flex flex-1 items-center justify-between min-w-0 relative">
              ...
              <div className="flex flex-1 flex-col justify-center min-w-0 gap-0.5">
                <div className="flex items-baseline justify-between w-full min-w-0">
                  <p className="font-['SF_Pro_Text',-apple-system,sans-serif] font-semibold text-[10.5px] leading-[15px] text-black tracking-[-0.23px] truncate">
                    {title}
                  </p>
                  <p className="font-['SF_Pro_Text',-apple-system,sans-serif] font-normal text-[9.5px] leading-[15px] text-gray-500 tracking-[-0.23px] ml-2 shrink-0 whitespace-nowrap">
                    {time}
                  </p>
                </div>
